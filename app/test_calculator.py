...
def test_divide2():
    ...
    assert divide2(1, 2) == 0.5
    assert divide2(1.0, 2.0) == 0.5
    assert divide2(4, 2) == 2.0
    assert divide2(0, 2.0) == 0.0
    assert divide2(-4, 2.0) == -2.0
    assert divide2(4, -2.0) == -2.0
    assert divide2(-4, -2.0) == 2.0
    # Test division by zero
    assert divide2(2.0, 0.0) == 'Cannot divide by 0'
